...
class Simulator(object):
    ...
    def __init__(self, env, size=None, update_delay=2.0, display=True, log_metrics=False, optimized=False , mini_trial=20):
        self.env = env
    ...
    def run(self, tolerance=0.05, n_test=0):
        ...
        while True:
            ...
            # Flip testing switch
            if not testing:
                if total_trials > self.mini_trial: # Must complete minimum training trials, default 20
                    if a.learning:
